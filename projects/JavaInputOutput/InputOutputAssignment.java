...
public class InputOutputAssignment {
    ...
    public static void main(String[] args){
        ...
        System.out.print("What year did the French invasion of Russia begin?: ");
        int invasionYear = in.nextInt();
        ...
        System.out.println(String.format("You said the French invasion of Russian began in %d", invasionYear));
    }
}
